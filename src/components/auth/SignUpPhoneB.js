...
class SignInPhone extends Component {
  ...
  handleSubmit = (e) => {
    ...
    this.props.signUpPhone({PhoneNum:phonen,userType:'Buyer',name:this.state.name,AlternateNum:this.state.AlternateNum})
  }
  render() {
...
<form  class="bg-white p-5 contact-form"  style={{height:'550px'}} onSubmit={this.handleSubmit}>
<div class="form-group">
<input type="text" id="name" class="form-control" placeholder="User Name" onChange={this.handleChange} required/>
</div>
<div class="form-group">
<input type="text"  class="form-control"id="AlternateNum" placeholder="Alternate Phone number" onChange={this.handleChange}/>
</div>
<div class="form-group">
